...
return [
    ...
    "media" => [
        "groups" => [
            "default" => [
                "ext" => ["jpg", 'jpeg', 'png', 'gif', 'bmp', 'docx', 'JPG', 'svg'], // add 'svg'
                "mime" => ["image/png", "image/jpeg", "image/gif", "image/bmp", 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', "image/svg+xml"], // Thêm "image/svg+xml"
            ...
            "image" => [
                "ext" => ["jpg", 'jpeg', 'png', 'gif', 'bmp', 'JPG', 'svg'], // add 'svg'
                "mime" => ["image/png", "image/jpeg", "image/gif", "image/bmp", "image/svg+xml"], // add "image/svg+xml"
                "max_size" => 20000000, // In Bytes, default is 20MB,
                "max_width" => env('ALLOW_IMAGE_MAX_WIDTH', 4000),
                "max_height" => env('ALLOW_IMAGE_MAX_HEIGHT', 4000)
            ],
