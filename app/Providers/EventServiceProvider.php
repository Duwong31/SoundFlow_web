...
//        ]
        ...
        BookingUpdatedEvent::class => [
            UpdateCarBookCompleteCount::class,
        ],
        ...
        BookingReturnLateEvent::class => [
            BookingNotificationListener::class . '@handleReturnLate',
        ],
    ];
