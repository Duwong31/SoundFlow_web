                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="car_layout_search" class="form-control" >
                                @foreach(config('car.layouts',['normal'=>__("Normal Layout"),'map'=>__("Map Layout")]) as $id=>$name))
                                    <option value="{{$id}}" {{ setting_item('car_layout_search','normal') == $id ? 'selected' : ''  }}>{{$name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3" data-condition="car_location_search_style:is(autocompletePlace)">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <select name="car_location_radius_type" id="">
                                        <option  {{ (setting_item('car_location_radius_type') ?? '') == 3959 ? 'selected' : ''  }} value="3959">{{__('Miles')}}</option>
                                        <option  {{ (setting_item('car_location_radius_type') ?? '') == 6371 ? 'selected' : ''  }} value="6371">{{__('Km')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="tab-content" >
                        ...
                        @php
                            $seo_share = json_decode(setting_item_with_lang('car_page_list_seo_share',request()->query('lang'),'[]'),true);
                        @endphp
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config review for car')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Enable review system for Car?")}}</label>
                        <div class="form-controls">
                            <label><input type="checkbox" name="car_enable_review" value="1" @if(!empty($settings['car_enable_review'])) checked @endif /> {{__("Yes, please enable it")}} </label>
                            <br>
                            <small class="form-text text-muted">{{__("Turn on the mode for reviewing car")}}</small>
                        </div>
                    </div>
                    <div class="form-group" data-condition="car_enable_review:is(1)">
                        <label class="" >{{__("Customer must book a car before writing a review?")}}</label>
                        <div class="form-controls">
                            <label><input type="checkbox" name="car_enable_review_after_booking" value="1"  @if(!empty($settings['car_enable_review_after_booking'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="car_enable_review:is(1),car_enable_review_after_booking:is(1)">
                        ...
                        <div class="form-controls">
                            @php
                                ...
                                $settings_status = !empty($settings['car_allow_review_after_making_completed_booking']) ? json_decode($settings['car_allow_review_after_making_completed_booking']) : [];
                            @endphp
                            <div class="row">
                                @foreach($status as $item)
                                    <div class="col-md-4">
                                        <label><input type="checkbox" name="car_allow_review_after_making_completed_booking[]" @if(in_array($item,$settings_status)) checked @endif value="{{$item}}"  /> {{booking_status_to_text($item)}} </label>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="form-group" data-condition="car_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="car_review_approved" value="1"  @if(!empty($settings['car_review_approved'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                            ...
                            <div class="form-group-item">
                                ...
                                <div class="g-items">
                                    ...
                                    @foreach($social_share as $key=>$item)
                                        <div class="item" data-number="{{$key}}">
                                            <div class="row">
                                                <div class="col-md-11">
                                                    <input type="text" name="car_review_stats[{{$key}}][title]" class="form-control" value="{{$item->title}}" placeholder="{{__('Eg: Service')}}">
                                                </div>
                                                <div class="col-md-1">
                                ...
                                <div class="g-more hide">
                                    <div class="item" data-number="__number__">
                                        <div class="row">
                                            <div class="col-md-11">
                                                <input type="text" __name__="car_review_stats[__number__][title]" class="form-control" value="" placeholder="{{__('Eg: Service')}}">
                                            </div>
                                            <div class="col-md-1">
                                                <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                            </div>
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            <h3 class="form-group-title">{{__("Fees Options")}}</h3>
            <p class="form-group-desc">{{__('Config  fees for car')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group-item">
                        <label class="control-label">{{__('Fees')}}</label>
                        <div class="g-items-header">
                            <div class="row">
                        ...
                        <div class="g-items">
                            ...
                            @if(!empty($settings['car_booking_delivery_fees']))
                                <?php $car_booking_delivery_fees = json_decode($settings['car_booking_delivery_fees'],true); ?>
                                @foreach($car_booking_delivery_fees as $key=>$delivery_fee)
                                    <div class="item" data-number="{{$key}}">
                                        <div class="row">
                                            <div class="col-md-5">
                                                @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                    @foreach($languages as $language)
                                                        ...
                                                        <div class="g-lang">
                                                            ...
                                                            <input type="text" name="car_booking_delivery_fees[{{$key}}][name{{$key_lang}}]" class="form-control" value="{{$delivery_fee['name'.$key_lang] ?? ''}}" placeholder="{{__('Fee name')}}">
                                                            <input type="text" name="car_booking_delivery_fees[{{$key}}][desc{{$key_lang}}]" class="form-control" value="{{$delivery_fee['desc'.$key_lang] ?? ''}}" placeholder="{{__('Fee desc')}}">
                                                        </div>

                                                    @endforeach
                                                @else
                                                    <input type="text" name="car_booking_delivery_fees[{{$key}}][name]" class="form-control" value="{{$delivery_fee['name'] ?? ''}}" placeholder="{{__('Fee name')}}">
                                                    <input type="text" name="car_booking_delivery_fees[{{$key}}][desc]" class="form-control" value="{{$delivery_fee['desc'] ?? ''}}" placeholder="{{__('Fee desc')}}">
                                                @endif
                                            </div>
                                            <div class="col-md-3">
                                                <input type="number" min="0" step="0.1" name="car_booking_delivery_fees[{{$key}}][price]" class="form-control" value="{{$delivery_fee['price']}}">
                                                <select name="car_booking_delivery_fees[{{$key}}][unit]" class="form-control">
                                                    <option @if(($delivery_fee['unit'] ?? "") ==  'fixed') selected @endif value="fixed">{{ __("Fixed") }}</option>
                                                    <option @if(($delivery_fee['unit'] ?? "") ==  'percent') selected @endif value="percent">{{ __("Percent") }}</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <select name="car_booking_delivery_fees[{{$key}}][type]" class="form-control d-none">
                                                    <option @if($delivery_fee['type'] ==  'one_time') selected @endif value="one_time">{{__("One-time")}}</option>
                                                </select>
                                            </div>
                                            <div class="col-md-1">
                                                <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                    ...
                                    <div class="col-md-5">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text" __name__="car_booking_delivery_fees[__number__][name{{$key}}]" class="form-control" value="" placeholder="{{__('Fee name')}}">
                                                    <input type="text" __name__="car_booking_delivery_fees[__number__][desc{{$key}}]" class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                                </div>

                                            @endforeach
                                        @else
                                            <input type="text" __name__="car_booking_delivery_fees[__number__][name]" class="form-control" value="" placeholder="{{__('Fee name')}}">
                                            <input type="text" __name__="car_booking_delivery_fees[__number__][desc]" class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                        @endif
                                    </div>
                                    <div class="col-md-3">
                                        <input type="number" min="0" step="0.1"  __name__="car_booking_delivery_fees[__number__][price]" class="form-control" value="">
                                        <select __name__="car_booking_delivery_fees[__number__][unit]" class="form-control">
                                            <option value="fixed">{{ __("Fixed") }}</option>
                                            <option value="percent">{{ __("Percent") }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <select __name__="car_booking_delivery_fees[__number__][type]" class="form-control d-none">
                                            <option value="one_time">{{__("One-time")}}</option>
                                        </select>
{{--                                        <label>--}}
{{--                                            <input type="checkbox" min="0" __name__="car_booking_delivery_fees[__number__][per_person]" value="on">--}}
{{--                                            {{__("Price per person")}}--}}
{{--                                        </label>--}}
                                    </div>
                                    <div class="col-md-1">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config buyer fees for car')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                                            ...
                                            <div class="col-md-5">
                                                @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                    @foreach($languages as $language)
                                                        ...
                                                        <div class="g-lang">
                                                            <div class="title-lang">{{$language->name}}</div>
                                                            <input type="text" name="car_booking_buyer_fees[{{$key}}][name{{$key_lang}}]" class="form-control" value="{{$buyer_fee['name'.$key_lang] ?? ''}}" placeholder="{{__('Fee name')}}">
                                                            <input type="text" name="car_booking_buyer_fees[{{$key}}][desc{{$key_lang}}]" class="form-control" value="{{$buyer_fee['desc'.$key_lang] ?? ''}}" placeholder="{{__('Fee desc')}}">
                                                        </div>

                                                    @endforeach
                                                @else
                                                    <input type="text" name="car_booking_buyer_fees[{{$key}}][name]" class="form-control" value="{{$buyer_fee['name'] ?? ''}}" placeholder="{{__('Fee name')}}">
                                                    <input type="text" name="car_booking_buyer_fees[{{$key}}][desc]" class="form-control" value="{{$buyer_fee['desc'] ?? ''}}" placeholder="{{__('Fee desc')}}">
                                                @endif
                                            </div>
                                            <div class="col-md-3">
                                                <input type="number" min="0" step="0.1" name="car_booking_buyer_fees[{{$key}}][price]" class="form-control" value="{{$buyer_fee['price']}}">
                                                <select name="car_booking_buyer_fees[{{$key}}][unit]" class="form-control">
                                    ...
                                    <div class="col-md-5">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text" __name__="car_booking_buyer_fees[__number__][name{{$key}}]" class="form-control" value="" placeholder="{{__('Fee name')}}">
                                                    <input type="text" __name__="car_booking_buyer_fees[__number__][desc{{$key}}]" class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                                </div>

                                            @endforeach
                                        @else
                                            <input type="text" __name__="car_booking_buyer_fees[__number__][name]" class="form-control" value="" placeholder="{{__('Fee name')}}">
                                            <input type="text" __name__="car_booking_buyer_fees[__number__][desc]" class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                        @endif
                                    </div>
                                    <div class="col-md-3">
                                        <input type="number" min="0" step="0.1"  __name__="car_booking_buyer_fees[__number__][price]" class="form-control" value="">
                                        <select __name__="car_booking_buyer_fees[__number__][unit]" class="form-control">
                                            <option value="fixed">{{ __("Fixed") }}</option>
                                            <option value="percent">{{ __("Percent") }}</option>
                                        </select>
                                    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Car created by vendor must be approved by admin")}}</label>
                        <div class="form-controls">
                            <label><input type="checkbox" name="car_vendor_create_service_must_approved_by_admin" value="1" @if(!empty($settings['car_vendor_create_service_must_approved_by_admin'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="car_allow_vendor_can_change_their_booking_status" value="1" @if(!empty($settings['car_allow_vendor_can_change_their_booking_status'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="car_allow_vendor_can_change_paid_amount" value="1" @if(!empty($settings['car_allow_vendor_can_change_paid_amount'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="car_allow_vendor_can_add_service_fee" value="1" @if(!empty($settings['car_allow_vendor_can_add_service_fee'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                    <label><input type="checkbox" name="car_deposit_enable" value="1" @if(setting_item('car_deposit_enable')) checked @endif > {{__('Yes, please enable it')}}</label>
                    </div>
                </div>
                <div class="form-group" data-condition="car_deposit_enable:is(1)">
                    <label >{{__('Deposit Amount')}}</label>
                    <div class="form-controls">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    <input type="number" name="car_deposit_amount" class="form-control" step="0.1" value="{{old('car_deposit_amount',setting_item('car_deposit_amount'))}}" >
                                    <select name="car_deposit_type"  class="form-control">
                                        <option value="fixed">{{__("Fixed")}}</option>
                                        <option @if(old('car_deposit_type',setting_item('car_deposit_type')) == 'percent') selected @endif value="percent">{{__("Percent")}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group" data-condition="car_deposit_enable:is(1)">
                    ...
                    <div class="form-controls">
                        <div class="row">
                            <div class="col-md-6">
                                <select name="car_deposit_fomular" class="form-control" >
                                    <option value="default" {{($settings['car_deposit_fomular'] ?? '') == 'default' ? 'selected' : ''  }}>{{__('Default')}}</option>
                                    <option value="deposit_and_fee" {{ ($settings['car_deposit_fomular'] ?? '') == 'deposit_and_fee' ? 'selected' : ''  }}>{{__("Deposit amount + Buyer free")}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
