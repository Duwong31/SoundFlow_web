...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h6>{{__("10 Hour Pricing")}}</h4>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="control-label">{{__("Price")}}</label>
                    <input type="number" step="any" min="0" name="price_per_10_hour" class="form-control" value="{{$row->price_per_10_hour}}" placeholder="{{__("10 Hour Price")}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="control-label">{{__("Sale Price")}}</label>
                    <input type="number" step="any" name="sale_price_per_10_hour" class="form-control" value="{{$row->sale_price_per_10_hour}}" placeholder="{{__("10 Hour Sale Price")}}">
                    <span><i>{{__("If the regular price is less than the discount, it will show the regular price")}}</i></span>
                </div>
            </div>
        </div>
