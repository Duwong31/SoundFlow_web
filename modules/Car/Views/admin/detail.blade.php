            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        @include('Car::admin.car.insurance_information')
                        @include('Car::admin.car.other_information')
                        @if(is_default_lang())
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="car_type" class="form-control">
                                            ...
                                            <option value="luxury" @if($row->car_type == 'luxury') selected @endif>{{__("Luxury")}}</option>
                                            <option value="mid_range" @if($row->car_type == 'mid_range') selected @endif>{{__("Mid Range")}}</option>
                                            <option value="pickup" @if($row->car_type == 'pickup') selected @endif>{{__("Pickup")}}</option>
                                            <option value="suv" @if($row->car_type == 'suv') selected @endif>{{__("SUV")}}</option>
                                            <option value="mpv" @if($row->car_type == 'mpv') selected @endif>{{__("MPV")}}</option>
                                            <option value="electric" @if($row->car_type == 'electric') selected @endif>{{__("Electric")}}</option>
                                        </select>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>{{__('Car Recommended')}}</label>
                                        <br>
                                        <label>
                                    ...
                                    <div class="form-group">
                                        <label>{{__('Car Authentication')}}</label>
                                        <br>
                                        <label>
                                            <input type="checkbox" name="car_auth" @if($row->car_auth) checked @endif value="1"> {{__("Authenticated")}}
                                        </label>
                                    </div>
    ...
    <script>
        jQuery(function ($) {
            ...
            $('select[name="car_type"]').on('change', function() {
                console.log('Car type selected:', $(this).val());
            });
        })
    </script>
@endpush
