                                ...
                                <td>
                                    @if($service = $row->service)
                                        ...
                                        @if($row->vendor)
                                            ...
                                            <span>{{$row->vendor->name_or_email.' (#'.$row->vendor_id.')' }}</span>
                                        @endif
                                    @else
                                        {{__("[Deleted]")}}
                                    @endif
        ...
        $(document).on('click','.btn-submit-note-vendor',function () {
            ...
            $.ajax({
                ...
                success:function (res) {
                    ...
                    {
                        if(!res.status){
                            parent.find('.message_box').html('<div class="text text-danger">'+res.message+'</div>');
                        }else{
                            parent.find('.message_box').html('<div class="text text-success">'+res.message+'</div>');
                        }
                    }
                },
                error:function (e) {
