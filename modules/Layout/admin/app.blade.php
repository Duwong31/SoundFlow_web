            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right">
                        {{date('Y')}} &copy; {{__('Car Core by')}} <a
                            href="{{__('https://theapp4u.com/')}}" target="_blank"
                        >{{__('TheApp4U')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://theapp4u.com/')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://theapp4u.com/')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
