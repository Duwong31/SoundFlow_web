            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $translation->subtitle ?? '' }}" placeholder="{{ __("Subtitle") }}" name="subtitle" class="form-control">
                                </div>
                                <div class="form-group">
                        ...
                        @include('News::admin.news.location', ['row' => $row])
        ...
        jQuery(function ($) {
            ...
            new BravoMapEngine('map_content', {
                ...
                ready: function (engineMap) {
                    ...
                    if (bookingCore.map_provider === 'map_search') {
