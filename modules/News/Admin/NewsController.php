...
class NewsController extends AdminController
{
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            ...
            'row'         => $row,
            'locations'   => \DB::table('bravo_locations')->where('status', 'publish')->get(),
            'breadcrumbs' => [
                [
                    'name' => __('News'),
                    'url'  => route('news.admin.index')
    ...
    public function getLocations(Request $request)
    {
        ...
        if($pre_selected && $selected){
            $items = DB::table('bravo_locations')->where('id', $selected)->select('id', 'name as text')->first();
            return [
                'results'=> $items ? [$items] : []
            ];
        }
        ...
        $q = $request->query('q');
        $query = DB::table('bravo_locations')
